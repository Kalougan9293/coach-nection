            ...
            (annonces as Annonce[]).map((annonce) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-shadow border border-gray-100 flex flex-col h-full"
                >
                  {statut === "trouve" && (
                    <span className="self-start text-[10px] font-medium px-2 py-1 rounded-md bg-emerald-50 text-emerald-800 mb-3">
                      ✅ TROUVÉ !
                    </span>
                  )}
                  {statut === "en_cours" && (
                    <span className="self-start text-[10px] font-medium px-2 py-1 rounded-md bg-amber-50 text-amber-800 mb-3">
                      ⏳ EN COURS
                    </span>
                  )}
                  <h3 className="font-bold text-[#1F2957] text-lg mb-4 flex-1">
                    {title}
                  </h3>
                  <div className="flex flex-col gap-3 mt-auto">
                    <div>
                      <span className="bg-[#FFFBEB] border border-[#FBBF24] text-[#1F2957] text-xs font-medium px-2.5 py-1 rounded-full truncate max-w-full inline-block">
                        {specialty}
                      </span>
                    </div>
                    <div>
                      <span className="bg-[#E8F0FE] text-[#1F2957] text-xs font-semibold px-3 py-1.5 rounded-full inline-block">
                        📍 {location}
                      </span>
                    </div>
